...
Devo crashed! This is always indicative of a bug within Devo.
A crash log has been placed at "crash.log" relative to your current
working directory. It would be immensely helpful if you could please
report the crash with Devo[1] so that we can fix this.

[1]: https://github.com/hashicorp/devopracy-cli/issues

!!!!!!!!!!!!!!!!!!!!!!!!!!! DEVO CRASH !!!!!!!!!!!!!!!!!!!!!!!!!!!!
`

// panicHandler is what is called by panicwrap when a panic is encountered
// within Devo. It is guaranteed to run after the resulting process has
